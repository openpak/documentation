...
The verified apps utilizing `automerge-openpakbot-prs` before May 28th have
...
The `automerge-openpakbot-prs` feature has been introduced back in 2019 to
...
[excreq]: https://docs.openpak.org/docs/for-app-authors/linter/#exceptions
