...
[shared-modules repository](https://github.com/OpenPak/shared-modules),
for use by applications being distributed with Openpak.

These can be used as a git submodule, like so:

```bash
git submodule add https://github.com/OpenPak/shared-modules.git
```
